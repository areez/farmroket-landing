          ...
          <div className="hero-content text-center py-16">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                ...
                <a href="https://outlook.office.com/bookwithme/user/48cc795072e74f5c997fec66dfc15db8@valiant.com.bd/meetingtype/dXqpDcIwYEqrf8q0lr6ijg2?anonymous&ismsaljsauthenabled&ep=mLinkFromTile" target="_blank" className="btn btn-outline btn-lg">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
