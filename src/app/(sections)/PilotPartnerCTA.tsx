          ...
          <div className="flex items-center justify-center">
            <div className="text-center text-white max-w-4xl mx-auto">
              <div className="mb-6">
                ...
                <p className="text-xl lg:text-2xl text-gray-800 mb-8 max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white/15 backdrop-blur-sm rounded-lg p-5 border border-white/20 hover:bg-white/20 transition-all duration-300">
                  ...
                  <h4 className="font-bold mb-2 text-gray-900 text-lg">Early Access</h4>
                  <p className="text-gray-800 text-sm leading-relaxed">Get platform access before public launch</p>
                </div>
                <div className="bg-white/15 backdrop-blur-sm rounded-lg p-5 border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <div className="w-14 h-14 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="w-7 h-7 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h4 className="font-bold mb-2 text-gray-900 text-lg">Special Pricing</h4>
                  <p className="text-gray-800 text-sm leading-relaxed">Locked-in pilot pricing for 12 months</p>
                </div>
                <div className="bg-white/15 backdrop-blur-sm rounded-lg p-5 border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <div className="w-14 h-14 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4">
                    <svg className="w-7 h-7 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h4 className="font-bold mb-2 text-gray-900 text-lg">Direct Support</h4>
                  <p className="text-gray-800 text-sm leading-relaxed">Dedicated onboarding and training</p>
                </div>
              </div>

              {/* CTA Button */}
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <button className="btn bg-neutral text-neutral-content btn-lg font-bold px-8 hover:bg-neutral/90 hover:scale-105 hover:shadow-lg transition-all duration-300 border-none">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                  Request Pilot Access
                </button>
                <div className="text-gray-900 text-sm bg-white/90 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/30 shadow-lg">
                  <span className="font-bold text-red-600">Limited spots:</span> <span className="font-semibold">Only 50 suppliers accepted</span>
                </div>
              </div>

              {/* Compliance Tags */}
              <div className="mt-8 flex flex-wrap justify-center items-center gap-4 text-gray-900 text-sm">
