export default function Features() {
  ...
  return (
    <section className="section-padding bg-gray-900/30 relative">
      ...
      <div className="absolute inset-0 glass-avocado-light opacity-30"></div>
        ...
        <div className="content-container">
          <div className="text-center mb-16">
            ...
            <p className="text-body-lg max-w-3xl mx-auto">
              Comprehensive tools for complete supply chain transparency
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
            <div className="glass-avocado-overlay p-8 rounded-2xl">
              <h3 className="heading-md">
                Ready to Transform Your Food Supply Chain?
              </h3>
              <p className="text-body text-gray-100 mb-6 max-w-2xl mx-auto">
